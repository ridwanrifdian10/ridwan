  ...
  <body class="bg-gradient-to-br from-blue-400 to-blue-600">
    <div class="flex h-screen justify-center items-center">
        <div class="w-96">
            ...
            <form action="{{ route('register') }}" method="POST" class="backdrop-blur-sm bg-white/30 p-8 rounded-lg shadow-lg w-full border border-white/30">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <button type="submit" class="w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600 transition duration-300">REGISTER</button>
                </div>
